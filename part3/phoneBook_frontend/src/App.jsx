...
const PersonForm = ({ persons, setPersons, newName, setNewName, newNumber, setNewNumber, handleNameChange, handleNumberChange, setMessage }) => {
  ...
  const handleDelete = (event, id, name) => {
    ...
    if (window.confirm(`Deleting ${name}. Are you sure?`)) {
      ...
      personService
        ...
        .catch(() => { setMessage(`Error: Information of ${name} has already been removed from server`) })
    }
    else {
